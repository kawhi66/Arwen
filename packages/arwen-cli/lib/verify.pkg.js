const { ErrorHandler, fs } = require("@arwen/arwen-utils");

/**
 * @description async middleware to verify if the current work directory is an valid arwen project
